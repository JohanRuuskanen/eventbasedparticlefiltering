...
if read_new
    ...
    for i1 = 1:m
        for i2 = 1:n
            ...
            E = load("/local/home/johanr/Projects/EBPF/test_linear/data/test_results_over_N/sim_" * string(i1) * "_" * string(i2) * ".jld", "results")
            ...
            for i3 = 1:k
                ...
                if i1 == ex
                    errors[1, :, i3] = mean(bpf_measure[:, idx_bpf], 2).^2
                    errors[2, :, i3] = mean(apf_measure[:, idx_apf], 2).^2
                end
